...
with open('./api.txt', 'r') as f:
    ...
    i = 0
    for line in lines:
        function_interface = prefix + line.strip()
                        ...
                        with open(file_path, 'r') as f:
                            ...
                            for match in matches:
                                if match[0] == function_name_to_search:
                                    ...
                                    with open('found_class.txt', 'a') as f:
                                        f.write(f"\n{file_path},{function_name_to_search},{match[1]}")
                                    break
        if target_class:
            i+=1
        else:
            #append function_interface to a file
            with open('not_found.txt', 'a') as f:
                f.write(function_interface)
                f.write(r"\n")
    print(i)
