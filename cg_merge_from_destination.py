...
if __name__ == '__main__':
    ...
    with concurrent.futures.ProcessPoolExecutor(max_workers=8) as executor:
        result = [x for x in executor.map(process_out_node, interface_namespace_paths)]
